...
(:init
	...
	(K-ag-pred depot0 pred--free)
	(K-pred depot0 pred--free)
	(K-ag-pred distributor1 pred--free)
	(K-pred distributor1 pred--free)
	(K-ag-pred distributor0 pred--free)
	(K-pred distributor0 pred--free)
	(K-ag-pred driver0 pred--free)
	(K-pred driver0 pred--free)
)
(:goal	(and
(on crate1 pallet1)
)
