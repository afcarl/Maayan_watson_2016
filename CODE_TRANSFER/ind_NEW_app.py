...
def compute_dist(path_to_dir, domain_name, problem_name, problem_path, subset, plan_steps, clean_plan_dict, pp):
                        ...
                        for pct in percentages:
                            for val in noise:
                                ...
                                for subset in agent_subsets:
                                    ...
                                    ret_val = compute_dist(path, domain_name, problem, problem_path, subset_stripped, plan_steps, clean_plan_dict, pp)
...
def delta(planner, domain_name, problem, path, problem_path, subset, agents_to_delete = []):
    best_plan_costs = []
