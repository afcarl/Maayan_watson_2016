...
for i, obs in enumerate(consideredobservation):
    ...
    discardactions = discardactions + "\n" + "     :duration (= ?duration 0)"  + "\n"
    if atObs == 1:
				explainactions = explainactions + "     :condition (and  (at start (considered_occur_init)) (at start " + preobservations[i] + "))"  + "\n"
				discardactions = discardactions + "     :condition (and  (at start (considered_occur_init)) )" + "\n"
    
				explainactions = explainactions + "     :effect (and (at start (not  (considered_occur_init))) (at start (considered_" + obs + ")) (at start (increase (total-cost) 1))))  "+ "\n"
				discardactions = discardactions + "     :effect (and (at start (not  (considered_occur_init))) (at start (considered_" + obs + ")) (at start (increase (total-cost) 2000))))"+ "\n"
    else:
				explainactions = explainactions + "     :condition (and ( at start (considered_" + prevobs + ") ) (at start " + preobservations[i] + " ))"  + "\n"
				discardactions = discardactions + "     :condition (and ( at start (considered_" + prevobs + ") ) )" + "\n"
				...
				discardactions = discardactions + "     :effect (and (at start (not (considered_" + prevobs + ") ) ) (at end (considered_" + obs + ")) (at start (increase (total-cost) 2000))))"+ "\n"
